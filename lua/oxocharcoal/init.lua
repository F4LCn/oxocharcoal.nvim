...
vim.api.nvim_set_hl(0, "keyword", {fg = "#A2CCFF", bg = oxocharcoal.none})
vim.api.nvim_set_hl(0, "identifier", {fg = "#96BE78", bg = oxocharcoal.none})
vim.api.nvim_set_hl(0, "string", {fg = "#96BE78", bg = oxocharcoal.none})
vim.api.nvim_set_hl(0, "escape_char", {fg = "#96BE78", bg = oxocharcoal.none})
vim.api.nvim_set_hl(0, "constant", {fg = "#96BE78", bg = oxocharcoal.none})
vim.api.nvim_set_hl(0, "comment", {fg = "#96BE78", bg = oxocharcoal.none})
vim.api.nvim_set_hl(0, "todo", {fg = "#96BE78", bg = oxocharcoal.none})
vim.api.nvim_set_hl(0, "note", {fg = "#96BE78", bg = oxocharcoal.none})
vim.api.nvim_set_hl(0, "warn", {fg = "#96BE78", bg = oxocharcoal.none})
vim.api.nvim_set_hl(0, "error", {fg = "#96BE78", bg = oxocharcoal.none})
vim.api.nvim_set_hl(0, "preprocessor", {fg = "#96BE78", bg = oxocharcoal.none})
vim.api.nvim_set_hl(0, "number", {fg = "#96BE78", bg = oxocharcoal.none})
vim.api.nvim_set_hl(0, "label", {fg = "#B7B7B7", bg = oxocharcoal.none})
vim.api.nvim_set_hl(0, "operator", {fg = "#96BE78", bg = oxocharcoal.none})
vim.api.nvim_set_hl(0, "type", {fg = "#96BE78", bg = oxocharcoal.none})
vim.api.nvim_set_hl(0, "method", {fg = "#96BE78", bg = oxocharcoal.none})
vim.api.nvim_set_hl(0, "punctuation", {fg = "#BED4E0", bg = oxocharcoal.none})
vim.api.nvim_set_hl(0, "instance_field", {fg = "#96BE78", bg = oxocharcoal.none})
vim.api.nvim_set_hl(0, "decorator", {fg = "#BBB529", bg = oxocharcoal.none})
vim.api.nvim_set_hl(0, "self_param", {fg = "#96BE78", bg = oxocharcoal.none})
