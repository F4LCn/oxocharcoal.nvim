...
vim.api.nvim_set_hl(0, "BufferLineSeparator", {bg = oxocharcoal.black, fg = oxocharcoal.abyss})
...
vim.api.nvim_set_hl(0, "BufferLineBackgroundSelected", {bg = oxocharcoal.black, fg = oxocharcoal.white})
