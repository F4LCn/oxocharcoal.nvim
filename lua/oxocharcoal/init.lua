...
local blend = "#080808"
local base09 = "#78a9ff"
local oxocharcoal = { black = black, grey01 = blend_hex(black, white, 0.085), grey02 = blend_hex(black, white, 0.18), grey03 =
blend_hex(black, white, 0.3), grey04 = blend_hex(black, white, 0.82), grey05 = blend_hex(black, white, 0.95), white =
white, cyan = "#08bdba", teal = "#3ddbd9", base09 = base09, blue = "#33b1ff", pink = "#ff7eb6", green = "#42be65", lavander =
"#be95ff", lightblue = "#82cfff", orange = "#ffc37e", color1 = "#94c4ff", color2 = "#e9b1ff", color3 = "#96be78", color4 =
"#50b4be", color6 = "#808080", color7 = "#c8b47d", color8 = "#61afe1", color9 = "#e88c00", color10 = "#dd3962", color11 =
"#c88cdc", color13 = "#b7b7b7", color14 = "#bed4e0", color16 = "#ffb987", color18 = "#ff9696", color19 = "#bbb529", color21 =
"#80ff80", color22 = "#ffcf97", color24 = "#97f1fd", color27 = "#dadfe5", color28 = "#61afe1", color29 = "#00ff00", color30 =
"#324146", color31 = "#c35082", color32 = "#283246", color33 = "#ffc86e", color34 = "#ff7eb6", color35 = "#c6dbff", blend =
blend, none = "NONE" }
...
vim.api.nvim_set_hl(0, "Search", { fg = oxocharcoal.white, bg = oxocharcoal.colowhiter32 })
...
vim.api.nvim_set_hl(0, "DiagnosticUnderlineWarn",
  { fg = oxocharcoal.none, sp = oxocharcoal.color9, bg = oxocharcoal.none, undercurl = true })
vim.api.nvim_set_hl(0, "DiagnosticUnderlineError",
  { fg = oxocharcoal.none, sp = oxocharcoal.color10, bg = oxocharcoal.none, undercurl = true })
vim.api.nvim_set_hl(0, "DiagnosticUnderlineInfo",
  { fg = oxocharcoal.none, sp = oxocharcoal.color28, bg = oxocharcoal.none, undercurl = true })
vim.api.nvim_set_hl(0, "DiagnosticUnderlineHint",
  { fg = oxocharcoal.none, sp = oxocharcoal.color29, bg = oxocharcoal.none, underdotted = true })
...
vim.api.nvim_set_hl(0, "StatusReplace", { fg = oxocharcoal.black, bg = oxocharcoal.color1 })
...
vim.api.nvim_set_hl(0, "StatusNormal", { fg = oxocharcoal.black, bg = oxocharcoal.color24 })
...
vim.api.nvim_set_hl(0, "CmpItemKindInterface", { fg = oxocharcoal.grey01, bg = oxocharcoal.color22 })
vim.api.nvim_set_hl(0, "CmpItemKindColor", { fg = oxocharcoal.grey01, bg = oxocharcoal.teal })
vim.api.nvim_set_hl(0, "CmpItemKindTypeParameter", { fg = oxocharcoal.grey01, bg = oxocharcoal.color2 })
vim.api.nvim_set_hl(0, "CmpItemKindText", { fg = oxocharcoal.grey01, bg = oxocharcoal.color27 })
vim.api.nvim_set_hl(0, "CmpItemKindEnum", { fg = oxocharcoal.grey01, bg = oxocharcoal.color2 })
vim.api.nvim_set_hl(0, "CmpItemKindKeyword", { fg = oxocharcoal.grey01, bg = oxocharcoal.color1 })
vim.api.nvim_set_hl(0, "CmpItemKindConstant", { fg = oxocharcoal.grey01, bg = oxocharcoal.color3 })
vim.api.nvim_set_hl(0, "CmpItemKindConstructor", { fg = oxocharcoal.grey01, bg = oxocharcoal.color2 })
vim.api.nvim_set_hl(0, "CmpItemKindReference", { fg = oxocharcoal.grey01, bg = oxocharcoal.orange })
vim.api.nvim_set_hl(0, "CmpItemKindFunction", { fg = oxocharcoal.grey01, bg = oxocharcoal.color16 })
vim.api.nvim_set_hl(0, "CmpItemKindStruct", { fg = oxocharcoal.grey01, bg = oxocharcoal.color2 })
vim.api.nvim_set_hl(0, "CmpItemKindClass", { fg = oxocharcoal.grey01, bg = oxocharcoal.color2 })
vim.api.nvim_set_hl(0, "CmpItemKindModule", { fg = oxocharcoal.grey01, bg = oxocharcoal.color2 })
vim.api.nvim_set_hl(0, "CmpItemKindOperator", { fg = oxocharcoal.grey01, bg = oxocharcoal.color14 })
vim.api.nvim_set_hl(0, "CmpItemKindField", { fg = oxocharcoal.grey01, bg = oxocharcoal.color18 })
vim.api.nvim_set_hl(0, "CmpItemKindProperty", { fg = oxocharcoal.grey01, bg = oxocharcoal.color18 })
vim.api.nvim_set_hl(0, "CmpItemKindEvent", { fg = oxocharcoal.grey01, bg = oxocharcoal.color18 })
...
vim.api.nvim_set_hl(0, "CmpItemKindVariable", { fg = oxocharcoal.grey01, bg = oxocharcoal.white })
vim.api.nvim_set_hl(0, "CmpItemKindFile", { fg = oxocharcoal.grey01, bg = oxocharcoal.lavander })
vim.api.nvim_set_hl(0, "CmpItemKindMethod", { fg = oxocharcoal.grey01, bg = oxocharcoal.color16 })
vim.api.nvim_set_hl(0, "CmpItemKindValue", { fg = oxocharcoal.grey01, bg = oxocharcoal.lightblue })
vim.api.nvim_set_hl(0, "CmpItemKindEnumMember", { fg = oxocharcoal.grey01, bg = oxocharcoal.color3 })
